...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'render a list of products filtered by min_price and max_price' do
    get products_path(min_price: 149, max_price: 200)
  ...
  test 'search a product by query_text' do
    get products_path(query_text: "Nintendo Switch")
  ...
  test 'sort products by expensive prices first' do
    ...
    assert_response :success
    assert_select '.product', 3
    assert_select '.products .product:first-child h2', 'Mcbook Air'
  end
  ...
  test 'allow to update a product ' do
    ...
    assert_equal flash[:notice], 'Updated product'
  end
