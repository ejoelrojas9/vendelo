class FindProducts
  ...
  # def products    # Es igual que hacer attr_reader :products
  #   @products
  # end
  ...
  def sort(scoped, order_by)
    order_by_query = Product::ORDER_BY.fetch(order_by&.to_sym, Product::ORDER_BY[:newest])   # & indica si el parametro existe aplica el metodo, en este caso .to_sym
